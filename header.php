                ...
                <div class="row">
                    ...
                    <a class="logo-item-li-1" href="index.html">
                        <svg id="Capa_1" enable-background="new 0 0 512 512" height="20" viewBox="0 0 512 512"
                            ...
                            <g>
                                <path d="m121.472 166.116c2.024 24.213 6.672 57.38 17.189 92.205 22.336 73.956 61.794 126.543 117.339 156.427
                            ...
                            2.879-11.657 8.263-14.349l150.219-75.109c4.223-2.11 9.193-2.111 13.416 0l150.22 75.109c5.384 2.691 8.638 8.342 8.263
                                    14.35-1.631 26.164-6.274 66.291-19.134 108.87-25.714 85.137-72.618 145.051-139.41 178.076z"/>
                            </g>
                        </svg>
                    </a>
                    <ul class="list">
                        <li class="li-item"><a class="item-li" href="#">Антивирусы</a></li>
                    ...
                    <div class="logo-item-li">
                        ...
                        <div class="drop-menu">
                            <div class="drop-menu-flex">
                                <a class="link-menu1 fas fa-cog" href="#"> Регистрация </a>
                                <a class="link-menu2 far fa-user-circle" href="auth.php"> Вход</a>
                            </div>
                        </div>
                    </div>
                </div>
